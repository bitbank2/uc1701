...
//
int uc1701Init(int iDC, int iReset, int iLED, int iCS, byte bFlip180, byte bInvert, int32_t iSpeed);
//
...
//
// Write a 1k buffer directly to the display (for animation)
//
void uc1701DumpBuffer(uint8_t *pBuffer);
